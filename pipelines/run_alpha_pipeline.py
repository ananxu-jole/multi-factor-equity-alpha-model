"""Run the extracted alpha-to-portfolio pipeline."""
...
from pipelines.orchestration import ALPHA_STAGE_SPECS, describe_pipeline, run_stage_specs  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run or describe the alpha pipeline.")
    ...
    if args.describe:
        describe_pipeline("alpha_pipeline", ALPHA_STAGE_SPECS)
        return 0
