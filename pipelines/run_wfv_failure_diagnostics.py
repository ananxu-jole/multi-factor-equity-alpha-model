"""CLI for WFV failure diagnostics research artifacts."""
...
from src.scoring.wfv_diagnostics import (  # noqa: E402
...
def _print_description() -> None:
    print("stage_id: wfv_failure_diagnostics")
    print(f"diagnostics_version: {WFV_DIAGNOSTICS_VERSION}")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run WFV failure diagnostics for selected research signals.")
    ...
    result = run_wfv_failure_diagnostics(
